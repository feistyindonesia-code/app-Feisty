# SQL untuk RLS Fix (Jalankan di Supabase SQL Editor)

Copy dan paste semua SQL ini ke Supabase Dashboard → SQL Editor:
...
CREATE POLICY "categories_read_all" ON product_categories FOR SELECT USING (true);
CREATE POLICY "categories_write_all" ON product_categories FOR ALL USING (true);
...
CREATE POLICY "outlets_read_all" ON outlets FOR SELECT USING (true);
CREATE POLICY "outlets_write_all" ON outlets FOR ALL USING (true);
...
CREATE POLICY "users_read_all" ON user_accounts FOR SELECT USING (true);
CREATE POLICY "users_write_all" ON user_accounts FOR ALL USING (true);
...
CREATE POLICY "orders_write_all" ON orders FOR ALL USING (true);
...
CREATE POLICY "order_items_read_all" ON order_items FOR SELECT USING (true);
CREATE POLICY "order_items_write_all" ON order_items FOR ALL USING (true);

-- ============================================================================
-- BOT SETTINGS POLICIES (if table exists)
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'bot_settings') THEN
    ...
    CREATE POLICY "bot_settings_read_all" ON bot_settings FOR SELECT USING (true);
    CREATE POLICY "bot_settings_write_all" ON bot_settings FOR ALL USING (true);
  END IF;
END $$;

-- ============================================================================
-- ORGANIZATIONS POLICIES (if table exists)
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'organizations') THEN
    ...
    CREATE POLICY "organizations_write_all" ON organizations FOR ALL USING (true);
  END IF;
END $$;

-- ============================================================================
-- PAYMENTS POLICIES (if table exists)
-- ============================================================================
DO $$ 
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'payments') THEN
    ...
    CREATE POLICY "payments_write_all" ON payments FOR ALL USING (true);
  END IF;
END $$;
```
...
Setelah itu, refresh admin dashboard dan coba lagi!
