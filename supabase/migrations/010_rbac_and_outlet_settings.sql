...
-- Note: delivery_zones might already exist from previous migrations
-- We'll handle this with separate statements

-- First, try to create table (will skip if exists)
